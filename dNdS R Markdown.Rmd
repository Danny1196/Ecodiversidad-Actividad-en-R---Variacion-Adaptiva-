...
#Respuesta - hay "outliers" en la propagacion de dN y dS. Siempre va ver, pero con estos outliers no puedes ver la majoria de tus datos. 

#Los vamos excluir labs


##Ahora queremos visualizar las diferencias entre los dos tipos de mutaciones entre los pares de especie y las difrencias en las frequencias de los dos tipos de mutaciones. Podemos usar "boxplot" - pero vamos usar violin plots para tambien visualizar el peso de los datos por el promedio de cada categoria de datos. 

##Use ggplot y tengo especializaciones en el codigo para incluyir leyenda, color en cada categoria de datos, titulos, etc. Pero el plot se consigue con los dos primeros lineas de datos seperados con un "+"

dN/dS Ratio Comparisons
```{r}
...
#Un problema en visualizar datos genomicos es que hay una muestra grande y la mayoria de los datos estan pesados dentro un "quantile" o dos. Pero en estos datos puedes notar outliers. 

#Piensas que hay diferencias entre los promedios de los datos (mutaciones) usando un T-test? 
...
#Usando T-test puedes notar que hay diferencia signifcado entra las frecuencia de las mutaciones silenciosas y no silenciosas - pero cada tipo de mutacion se miran similar entre los dos pares de especies. 


#En conclusion, hay mas genes en selecion positiva entre el especie par de Sebastes mas recientemente divergido y hay diferencia entre las frequencias de mutaciones silenciosas y no silenciosas entre los dos pares de especies. Este puede indicar que dentro de las especiacion, pares de especies que se diverdigon mas recientemente tienen mas selecion positiva influendo su evolucion comparados a especies que se divergiendon con mas tiempo atras. 

#Que piensan que se puede mejorar para detectar la selecion positiva, neutral y negativa? 
